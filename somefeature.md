...
**Crews** are persistent friend groups (think study groups, hiking buddies, or a weekend brunch crew). Users can create crews with a name, description, and tags, then others can join or leave.

**Missions** are one-time events or activities. A user creates a mission with a title, description, time, location, and tags. Others can RSVP. The server tracks RSVP counts.

Both crews and missions appear in the discover tab, ranked by how well their tags match your interests.
